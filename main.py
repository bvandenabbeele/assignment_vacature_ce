...
# heat pump COP model: efficiency * t_cond / (t_cond - t_outside)
...
if __name__ == "__main__":
    ...
    # create a dataframe from the data, then create a thermostat setpoint array and calculate the heat demand and heat pump power
    ...
    if not os.path.exists("output"):
        os.mkdir("output")
    data.to_excel("output/result.xlsx")
